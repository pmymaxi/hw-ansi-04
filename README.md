...
Проект автоматизирует развертывание инфраструктуры мониторинга и сбора логов с использованием системы управления конфигурациями Ansible.
...
- Управление ingress необходимых TCP портов на firewalld
